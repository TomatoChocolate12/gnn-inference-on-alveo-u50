...
open_project gnn
set_top gnn
# v++ -g, -D, -I, --advanced.prop kernel.gnn.kernel_flags
add_files "/home/yashas.b/gnn-inference-on-alveo-u50/kernel/gnn_hls.cpp" -cflags " -D TEST_MODE -I /home/yashas.b/gnn-inference-on-alveo-u50/kernel"
...
config_export -format xo -ipname gnn
csynth_design
export_design
close_project
